...
export const Brokers = () => {
  ...
  const handleopen = () => {
    let broker = Broker.filter((item) => {
      return item["Market Type"] == "Open Market" && item["Year"] == year;
    });
  ...
  useEffect(() => {
    if (open.length > 0) {
      ...
      const ctx = document.getElementById("brokers-chart");
            ...
            datasets: [
              {
                label: "GWP",
                data: gwps,
                backgroundColor: "rgba(46, 170, 223, 0.6)", // Adjust color as needed
                borderWidth: 0.5,
